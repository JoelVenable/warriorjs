  ...
  action = this.unitHandler(warrior, feel, quad, action);
    ...
    */
    ...
    action = this.shootHandler(warrior, quad, action);
        ...
        warrior.think(`shootHandler: ${e}`);
      }
      
    try {
      action = this.heal(warrior, action, takingDamage);
    } catch (e) {
      warrior.think(`heal: ${e}`);
    }
    /* heal() does: 
